...
urlpatterns = [
    ...
    path(r'^login/$', views.aaron_login, name='aaron_login'),
    ...
    path(r'^admin/index/<int:job_id>/<int:applicant_id>/$', views.employer_job_applicant, name='employer_job_applicant'),
    path(r'^admin/index/<int:job_id>/<int:applicant_id>/feedback/$', views.applicant_feedback, name='applicant_feedback'),
    path(r'^admin/index/<int:job_id>/$', views.employer_job, name='employer_job'),
]
